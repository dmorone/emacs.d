...
;;; Copyleft Diego Morone

;; Original from Nikita Prokopov (tonsky) at https://github.com/tonsky/vscode-theme-alabaster
;; and Wanderson Ferreira at https://github.com/wandersoncferreira/alabaster-theme
...
(let ((class '((class color) (min-colors 89)))
      (alabaster-fg             "#000")
      (alabaster-bg             "#F7F7F7")
      (alabaster-comments-fg    "#6d6607")
      (alabaster-comments-bg    "#FFFABC")
      (alabaster-strings        "#448C27")
      (alabaster-keywords       "#7A3E9D")
      (alabaster-names          "#777777")
      (alabaster-fn-fg          "#195b7c")
      (alabaster-fn-bg          "#DBF1FF")
      (alabaster-punctuation    "#777777")
      (alabaster-paren-match    "#777777")
      (alabaster-paren-match-bg "gray85")
      (alabaster-line-hl        "#F7F7F7")
      (alabaster-hl             "#FFBC5D")
  ...
  (custom-theme-set-faces
   ...
   `(font-lock-builtin-face ((,class (:foreground ,alabaster-names))))
   `(font-lock-comment-face ((,class (:foreground ,alabaster-comments-fg :background ,alabaster-comments-bg))))
   `(font-lock-constant-face ((,class (:foreground ,alabaster-keywords))))
   `(font-lock-function-name-face ((,class (:foreground ,alabaster-fn-fg :background ,alabaster-fn-bg))))
   `(font-lock-keyword-face ((,class (:foreground ,alabaster-names))))
   `(font-lock-string-face ((t (:foreground ,alabaster-strings))) t)
   `(font-lock-type-face ((t (:foreground ,alabaster-names))))
   `(font-lock-variable-name-face ((,class (:foreground ,alabaster-names))))
   ...
   `(mode-line-inactive ((,class (:box (:line-width -1 :style released-button) :background ,alabaster-modeline-bg :foreground ,alabaster-punctuation))))
